...
at `recall_mcp.integrations.codex.recall_session`, so `pip install
...
old checkout-relative path keep working; update your Codex `hooks.json` (or
...
print(
    "integrations/codex/recall_session.py is deprecated; "
    "the implementation now ships inside the recall_mcp package "
    "(recall_mcp.integrations.codex.recall_session). "
    "Delegating for now.",
    file=sys.stderr,
)

from recall_mcp.integrations.codex.recall_session import main  # noqa: E402
