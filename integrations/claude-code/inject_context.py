...
at `recall_mcp.integrations.claude_code.inject_context`, so `pip install
...
print(
    "integrations/claude-code/inject_context.py is deprecated; "
    "the implementation now ships inside the recall_mcp package "
    "(recall_mcp.integrations.claude_code.inject_context). "
    "Delegating for now.",
    file=sys.stderr,
)

from recall_mcp.integrations.claude_code.inject_context import main  # noqa: E402
